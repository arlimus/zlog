...
describe Zlog::Layouts::SimpleSymbolic do
  before :each do 
    @layout = Zlog::Layouts.symbolic
  ...
  def pattern_for name, data = "yelloo", logger = "SpecLog"
    (Zlog::Layouts::SimpleCore::STDOUT_SYMBOLIC_PATTERN_256COLORS[name] % data)
  end

  it "can be initialized via simple method" do
    Zlog::Layouts.symbolic.must_be_instance_of Zlog::Layouts::SimpleSymbolic
  end
